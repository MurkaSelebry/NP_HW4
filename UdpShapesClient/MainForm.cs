...
namespace UdpShapesClient {
    public partial class MainForm : Form {
        ...
        public void ConnectToServer (Player player) {
            ...
            server = new UdpClient ("192.168.1.68", Ports.Server);
        ...
        {
            ChangeColor form = new ChangeColor();
            form.MainForm = this;
            form.ShowDialog();
            ...
            {
                MessageBox.Show("Color not changed");
                form.Dispose();
            }
        ...
        {
            players[MyName].Red = color.R;
            players[MyName].Blue = color.B;
            players[MyName].Green = color.G;
            byte[] changeColor = players[MyName].ChangeColorMessage();
            server.Send(changeColor, changeColor.Length);
        }
    }
}
